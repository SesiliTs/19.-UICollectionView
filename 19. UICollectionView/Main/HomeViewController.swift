...
//  19. UICollectionView
//
//  Created by Sesili Tsikaridze on 03.11.23.
//
...
extension HomeViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.filmPoster.image = currentFilm.image
        cell.filmNameLabel.text = currentFilm.name
        cell.filmCategoryLabel.text = "\(currentFilm.category)"
        cell.ratingLabel.text = "\(currentFilm.rating)"
        return cell
    }
